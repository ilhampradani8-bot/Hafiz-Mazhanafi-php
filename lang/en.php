...
$t = [
    ...
    // --- HERO & HEADER ---
    'hero_title' => "Experience The <br> <span class='text-lexusGold font-bold'>Extraordinary</span>",
    ...
    'svc_1_title' => "We Come To You",
    'svc_1_desc' => "Busy schedule? I provide door-to-door service for consultations, test drives, and document signing at your convenience.",
    ...
    'contact_address' => "Lexus Subang (PCM Subang Motor)<br>Lot 61716, Jalan SS16/1,<br>47500 Subang Jaya, Selangor",
    
    'ft_links' => "QUICK LINKS",
    'ft_form_title' => "SEND INQUIRY",
    'footer_bio' => "Professional Sales Consultant dedicated to providing the ultimate Lexus ownership experience with integrity.",
    ...
    'form_ph_name' => "Type your name...",
    'form_label_phone' => "Phone Number",
    'form_ph_phone' => "+60...",
    'form_label_msg' => "Message (Optional)",
    'form_ph_msg' => "I am interested in Lexus...",
    ...
    'rev_1' => "Hafiz provided exceptional service! He brought the car to my office for a test drive. The delivery of my RX350 was seamless.",
    'rev_2' => "Very professional. I didn't have to visit the showroom until the handover. Hafiz handled everything via WhatsApp and home visits.",
    ...
    'car_es_name' => "Lexus ES 250",
    'car_es_tag' => "THE EXECUTIVE SEDAN",
    
    // Fallback Lineup
    'car_5_name' => "Lexus Lineup",
    'car_5_tag' => "Explore All",
    'car_5_engine' => "Various",
    'car_5_power' => "Infinite",
    'car_5_desc' => "Discover the full range of Lexus vehicles tailored to your lifestyle.",
    // ... di dalam array $t
    'nav_gal_cars' => "CARS COLLECTION",
    'nav_gal_testi' => "HAPPY CLIENTS",

    // --- TESTIMONIALS PAGE ---
    'testi_header' => "TRUSTED BY <br> MALAYSIA'S FINEST",
    
    // Kita buat 5 template quote generic yang akan di-putar
    'quote_1' => "Alhamdulillah, the process was very easy and fast. Thank you Hafiz!",
    'quote_2' => "Very professional service from start to finish. Highly recommended.",
    'quote_3' => "Best service! The car arrived in perfect condition.",
    'quote_4' => "A truly premium experience. Hafiz handled everything perfectly.",
    'quote_5' => "Very satisfied. Friendly service and very helpful.",
    ...
    'testi_head_main' => "TRUSTED BY <span class='text-lexusGold'>100+</span> CLIENTS",
    
    'car_lm_name' => "Lexus LM 500h",
    'car_lm_tag' => "THE LUXURY MOVER",
    'car_gx_name' => "Lexus GX 550",
    'car_gx_tag' => "THE SOPHISTICATED ADVENTURER",

    // --- TAMBAHAN LEXUS EXPERIENCE ---
    'job_lexus_desc' => "
        <li>Engaging and converting leads through showroom visits, digital platforms, and corporate networking.</li>
        <li>Managing end-to-end customer journey from consultation and test drive to vehicle delivery.</li>
        <li>Coordinating with banks and internal teams for financing, insurance, and documentation processes.</li>
    ",
    'nav_testi' => 'TESTIMONIALS',
